...
:PROPERTIES:
:header-args: :tangle no :mkdirp yes :tangle-mode (identity #o755) :noweb yes :comments link
...
*** Preamble
:PROPERTIES:
:ID:       d6cad938-2389-4fbd-9f9d-a0a5308d0aec
:END:
#+begin_src snakemake
...
:PROPERTIES:
:ID:       36473f6e-c7fd-4aff-b549-d7eac89f7bcc
:END:
...
:PROPERTIES:
:ID:       8b5a87cc-8615-4df1-ae65-6142147fd42a
:END:
