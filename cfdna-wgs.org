...
rule frag_index:
    benchmark: f"{bench_dir}/frag_index.benchmark.txt",
    input: genome_fasta,
    log: f"{log_dir}/frag_index.log",
...
rule frag_fastp:
    benchmark: f"{bench_dir}/{{library}}_frag_fastp.benchmark.txt",
    input:
        read1 = f"{frag_fastq_dir/{{library}}_raw_R1.fastq.gz",
        read2 = f"{frag_fastq_dir/{{library}}_raw_R2.fastq.gz",
    log:
        cmd = f"{log_dir/{{library}}_frag_fastp.log",
        html = f"{log_dir/{{library}}_frag_fastp.html",
        json = f"{log_dir/{{library}}_frag_fastp.json",
    output:
        read1 = f"{frag_fastq_dir}/{{library}}_processed_R1.fastq.gz",
        read2 = f"{frag_fastq_dir}/{{library}}_processed_R2.fastq.gz",
        failed = f"{frag_fastq_dir}/{{library}}_failed_fastp.fastq.gz",
        unpaired1 = f"{frag_fastq_dir}/{{library}}_unpaired_R1.fastq.gz",
        unpaired2 = f"{frag_fastq_dir}/{{library}}_unpaired_R2.fastq.gz",
    params:
        script = f"{frag_script_dir}/fastp.sh",
...
rule frag_align:
    ...
    params:
        script = f"{frag_script_dir}/align.sh",
        threads = 4,
    resources:
        mem_mb = 500,
    shell:
...
rule frag_dedup:
    ...
    params:
        script = f"{frag_script_dir}/dedup.sh",
        threads = frag_threads,
    shell:
        """
        {params.script} \
...
checkpoint frag_filter_alignment:
    ...
    params:
        script = f"{frag_script_dir}/filter_alignment.sh",
        threads = frag_threads,
    shell:
        """
        {params.script} \
...
rule frag_fastqc:
    ...
    params:
        outdir = qcdir,
        script = f"{frag_script_dir}/fastqc.sh",
        threads = frag_threads,
    shell:
        """
        {params.script} \
...
rule frag_picard_depth:
    ...
    params:
        script = f"{frag_script_dir}/picard_depth.sh",
        threads = frag_threads,
    shell:
        """
        {params.script} \
...
rule frag_bampefragsize:
    ...
    params:
        ...
        script = f"{frag_script_dir}/bampefragsize.sh",
        threads = frag_threads,
    shell:
        """
        {params.script} \
...
rule frag_bamcoverage:
    ...
    params:
        bin = "10000",
        blacklist = config["blklist"],
        script = f"{frag_script_dir}/bamcoverage.sh",
        threads = frag_threads,
    shell:
        """
        {params.script} \
...
rule frag_plotcoverage:
    ...
    output:
        ...
        plot = qcdir + "/frag_coverage.pdf",
    params:
        blacklist = config["blklist"],
        script = f"{frag_script_dir}/plotcoverage.sh",
        threads = frag_threads,
    shell:
        """
        {params.script} \
...
rule frag_multiqc:
    ...
    params:
        ...
        script = f"{frag_script_dir}/multiqc.sh",
        threads = frag_threads,
    shell:
        """
        {params.script} \
...
checkpoint frag_make_qc_tsv:
    ...
    params:
        script = f"{frag_script_dir}/make_qc_tsv.R",
    shell:
        """
...
rule make_gc_map_bind:
    ...
    params:
        script = f"{frag_script_dir}/make_gc_map_bind.sh",
    shell:
        """
        {params.script} \
        {input.gc5mb} \
...
rule filt_bam_to_frag_bed:
    ...
    params:
        fasta = genome_fasta,
        script = f"{frag_script_dir}/filt_bam_to_frag_bed.sh",
        threads = frag_threads,
    shell:
        """
        {params.script} \
...
rule gc_distro:
    ...
    params:
        script = f"{frag_script_dir}/gc_distro.R",
    shell:
        """
        Rscript {params.script} \
        {input} \
...
rule healthy_gc:
    ...
    params:
        ...
        script = f"{frag_script_dir}/healthy_gc.R",
    shell:
        """
        Rscript {params.script} \
        {params.distro_dir} \
...
rule frag_gc_sample:
    ...
    params:
        script = f"{frag_script_dir}/gc_sample.R",
    shell:
        """
        Rscript {params.script} \
        {input.healthy_med} \
...
rule frag_sum:
    ...
    params:
        script = f"{frag_script_dir}/frag_window_sum.sh",
        threads = frag_threads,
    shell:
        """
        {params.script} \
...
rule frag_window_count:
    ...
    params:
        script = f"{frag_script_dir}/frag_window_int.sh",
        threads = threads,
    shell:
        """
        {params.script} \
...
rule frag_count_merge:
    ...
    params:
        ...
        script = f"{frag_script_dir}/count_merge.sh",
        threads = frag_threads,
    shell:
        """
        {params.script} \
...
rule unit_cent_sd:
    ...
    params:
        script = f"{frag_script_dir}/make_ratios.R",
    shell:
        """
        Rscript {params.script} \
...
rule symlink_inputs:
    ...
    params:
        outdir = frag_fastqs,
        script = f"{frag_script_dir}/symlink.sh",
    shell:
        """
        {params.script} \
        {input} \
...
rule frag_filt:
    ...
    params:
        script = f"{frag_script_dir}/frag_filt.sh",
        threads = frag_threads,
    shell:
        """
...
rule downsample_bams:
    ...
    params:
        out_dir = frag_bams,
        script = f"{frag_script_dir}/downsample_bams.sh",
        suffix = "_filt.bam",
        threads = frag_threads,
    shell:
        """
...
rule bam_to_wig:
    ...
    params:
        chrs = chrs,
        outdir = frag_wigs,
        script = f"{frag_script_dir}/bam_to_wig.sh",
        threads = frag_threads,
    shell:
        """
...
rule ichor_nopon:
    ...
    params:
        script = f"{frag_script_dir}/MOD_runIchorCNA.R",
...
rule frag_downsample:
    ...
    params:
        milreads = MILREADS,
        script = f"{frag_script_dir}/downsample.sh",
        threads = frag_threads,
    shell:
        """
        {params.script} \
