...
- Appropriate reference fasta, GCA_000001405.15_GRCh38_no_alt_analysis_set.fna (available from ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/001/405/GCA_000001405.15_GRCh38/seqs_for_alignment_pipelines.ucsc_ids/GCA_000001405.15_GRCh38_no_alt_analysis_set.fna.gz)


Clear motifs data directory if present:
...
Generate motifs from 5' ends of bams:
...
scripts/sample_motifs.py --bam_file data/bams/human1.bam --output_file data/motifs/human1_motifs.tsv --motif_length 4 --num_reads 10000 --threads 4 --reference_genome $REFERENCE_GENOME
...
Consolidate to a single matrix:
