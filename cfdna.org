...
** cfDNA chromatin immunoprecipitation
10.26508/lsa.202302003
https://doi-org.mclibrary.idm.oclc.org/10.1158/0008-5472.CAN-24-2052
[cite:@sadeh2021cfchipseq]
...
:END:
- [2025-09-03 Wed] - Begin version tracking at workflow level. cfdna-cna v1.0.0
...
<#~/repos/basecamp/basecamp.org:smk_comment_modular_wrapper()#>

<#~/repos/basecamp/basecamp.org:smk_comment_datadir_wrapper()#>
...
*** cfDNA WGS
#+begin_src bash
wget -O /mnt/data/projects/cfdna/inputs/GCA_000001405.15_GRCh38_no_alt_analysis_set.fa.gz \
  https://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/001/405/GCA_000001405.15_GRCh38/seqs_for_alignment_pipelines.ucsc_ids/GCA_000001405.15_GRCh38_no_alt_analysis_set.fna.gz

#+end_src

#+begin_src yaml :tangle ./config/TEST_cfdna_wgs.smk
ref_assemblies:
  ncbi_hg38:
    url:
      "https://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/001/405/GCA_000001405.15_GRCh38/seqs_for_alignment_pipelines.ucsc_ids/GCA_000001405.15_GRCh38_no_alt_analysis_set.fna.gz"
...
*** cfDNA copy number
- [ ] make pon a dependency for the ichor step
...
:END:
- TODO MAKE PON and ichor dependnecy
...
: - project-data-dir
: - samples-tsv
*** Extract ichorCNA params into tsv
:PROPERTIES:
:ID:       203028d1-a683-45e3-9584-10a95a70950d
:END:
#+begin_src R :tangle ./scripts/params_to_tsv.R
#!/usr/bin/env Rscript
