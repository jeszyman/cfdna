...
rule cfdna_cna_downsample_bam:
    conda:
        f"{config['cfdna-cna-conda-env']}",
    input:
        f"{config['cfdna-cna-dir']}/bams/{{wkflow_id}}.bam",
    log:
        f"{config['log-dir']}/{{wkflow_id}}.{{mil_reads}}_cfdna_cna_downsample.log",
    output:
        bam = f"{config['cfdna-cna-dir']}/ds-bams/{{wkflow_id}}.ds{{mil_reads}}.bam",
        bai = f"{config['cfdna-cna-dir']}/ds-bams/{{wkflow_id}}.ds{{mil_reads}}.bam.bai",
    params:
